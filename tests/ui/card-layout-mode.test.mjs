...
test("compact-mode.css hides progress bars in compact mode", () => {
  const css = fs.readFileSync(path.resolve("src/styles/desktop/compact-mode.css"), "utf8");
...
test("Antigravity account email displays fully without 95px truncation", () => {
  const compactCss = fs.readFileSync(path.resolve("src/styles/desktop/compact-mode.css"), "utf8");
  const agyCss = fs.readFileSync(path.resolve("src/styles/antigravity/antigravity.css"), "utf8");
