...
Function RestorePreviousInstallLocation
  ; 1. Try Uninstall key in HKCU
  ReadRegStr $4 HKCU "${UNINSTKEY}" "InstallLocation"
  ${If} $4 != ""
    StrCpy $INSTDIR $4
    Goto done
  ${EndIf}

  ; 2. Try Uninstall key in HKLM
  ReadRegStr $4 HKLM "${UNINSTKEY}" "InstallLocation"
  ${If} $4 != ""
    StrCpy $INSTDIR $4
    Goto done
  ${EndIf}

  ; 3. Try Manufacturer key in HKCU
  ...
  ; 4. Try Manufacturer key in HKLM
