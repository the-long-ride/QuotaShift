...
#[path = "parser_buckets.rs"]
pub(crate) mod parser_buckets;
pub(crate) use parser_buckets::*;
// Contract references: classify_bucket_window, remaining_fraction: Option<f64>

#[path = "parser_models.rs"]
pub(crate) mod parser_models;
#[allow(unused_imports)]
pub(crate) use parser_models::*;
