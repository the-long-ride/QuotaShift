...
export const PassphraseModal: React.FC<PassphraseModalProps> = ({
  ...
  if (mode === "create") {
    ...
    description =
      "Create a passphrase to encrypt your stored accounts and tokens. You'll need this passphrase to decrypt/import or encrypt/export backups.";
    submitLabel = "Set Passphrase";
  } else if (mode === "export") {
    title = "Encrypt Export Backup";
    description =
      "Create a passphrase to encrypt your exported backup file. You will need this passphrase to decrypt and import this backup later.";
    ...
    description =
      "Enter your current passphrase to decrypt your database. Your credentials will be saved in plaintext local storage, and you will not be prompted for a passphrase on startup anymore.";
